  ...
  <form @submit.prevent="submit" class="h-screen flex body-background">
    <div class="bg-white w-[24rem] m-auto p-10 rounded-lg shadow-md flex flex-col justify-center">
      ...
      <div class="flex justify-center text-center flex-col">
        <span class="font-bold">Email de recuperação enviado com sucesso!</span>
        <span class="mt-5 mb-8 text-smbg-primary/10 text-primary font-semibold rounded-md p-4">Você receberá um link de recuperação no e-mail inserido em até 10 minutos!</span>
      </div>
      <div class="space-y-5">
        <div class="flex justify-center items-center space-x-2">
          ...
          <a :href="route('login')" class="text-primary uppercase font-extrabold text-[12px]">Voltar para login</a>
        </div>
        <div class="flex justify-center">
