  ...
  <form @submit.prevent="submit" class="h-screen flex body-background">
    <div class="bg-white w-[24rem] m-auto p-10 rounded-lg shadow-md flex flex-col justify-center">
      ...
      <div class="space-y-5">
        ...
        <div class="">
          <button type="submit" class="bg-primary text-white rounded-md py-3 w-full text-sm flex items-center justify-center" :class="{'bg-opacity-70 cursor-wait': sending}">
        ...
        <div class="flex justify-center">
          <Link :href="route('login')" class="text-primary uppercase font-extrabold text-[12px]">Voltar para login</Link>
        </div>
        <div class="flex justify-center">
          <span class="text-gray-400 text-[10px]">Projeto Estagio primary - Todos os Direitos Reservados ©</span>
        </div>
      </div>
    </div>
  </form>
