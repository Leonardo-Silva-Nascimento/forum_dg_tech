  ...
  <SideBar >
    <div class="bg-white shadow-md max-lg:hidden lg:w-60 h-full fixed top-0 transition-all duration-300 z-50 overflow-y-auto" :class="{'!w-20': toggleMenu}">
      ...
      <nav class="mt-6 list-none px-7">
        ...
        <Link as="button"  :href="route('list.Forum')">
        <li class="flex text-gray-500/80 font-semibold space-x-3 items-center text-[14.5px] hover:text-primary">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
          <span v-show="!toggleTextMenu">Forum</span>
        </li>
      </Link>
        ...
        <Link as="button" :href="route('list.ForumCalendario')" v-if="$page.props.userPermissions.includes('list.ForumCalendario')">
        <li class="flex text-gray-500/80 font-semibold space-x-3 items-center text-[14px] mt-2 hover:text-primary">
        ...
        <li class="text-[14px] cursor-pointer mb-3" style="margin-top: 4%">
          <div @click="dropdownConfig = !dropdownConfig" class="flex text-gray-500/80 hover:text-primary font-semibold space-x-3 items-center"
          ...
          <SlideUpDown v-model="dropdownConfig" :duration="300" v-show="!toggleMenu">
            <ul class="ml-8 mt-2 mb-4 text-gray-400 font-normal space-y-3">
              ...
              <li class="flex space-x-2 items-center hover:text-primary">
...
<!-- #ModificaAqui -->
        ...
        <li class="flex text-gray-500/80 font-semibold space-x-3 items-center text-[14px] mt-2 hover:text-primary">
          ...
          <div @click="dropLogs = !dropLogs" class="flex text-gray-500/80 hover:text-primary font-semibold space-x-3 items-center" v-if="$page.props.userPermissions.includes('list.logs') || $page.props.userPermissions.includes('list.logsErros')">
            <div class="w-6 h=6">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
          ...
          <SlideUpDown v-model="dropLogs" :duration="300" v-show="!toggleMenu">
            <ul class="mt-2 mb-2 text-gray-400 font-normal space-y-3">
              ...
              <li class="flex space-x-1 items-center hover:text-primary">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
<!-- #ModificaAqui -->
        ...
        <li class="flex text-gray-500/80 font-semibold space-x-3 items-center text-[14px] mt-2">
          ...
          <span v-show="!toggleTextMenu">Permissões &nbsp;&nbsp;</span>
           ...
           <li class="text-[14px] cursor-pointer mb-3 space-x-3 space-y-3" style="margin-top:8%" > 
          <div @click="dropLogs = !dropLogs" class="flex text-gray-500/80 hover:text-primary font-semibold space-x-3 items-center" v-if="$page.props.userPermissions.includes('list.logsUsuario') || $page.props.userPermissions.includes('list.logsErros') || $page.props.userPermissions.includes('list.logs')">
            <div class="w-6 h=6">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z" />
              </svg>
